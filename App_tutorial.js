...
class App extends React.Component {
  ...
  componentDidMount = () => {
    ...
    this.socket = io.connect(`https://${Config.DOMAIN_MAIN}/`, {
      path: '/webrtcPeer',
    });
    ...
    const success = (stream) => {
      console.log(`[tutorial] App stream toURL`,stream.toURL())
      this.setState({
        localStream: stream
      })
    ...
    mediaDevices.enumerateDevices().then(sourceInfos => {
      console.log(`[tutorial] App sourceInfos`,sourceInfos);
      let videoSourceId;
  ...
  render() {
    const {
     ...
     console.log(`[tutorial] localStream`, localStream);
